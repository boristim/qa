...
<?php if (!empty($page['header'])): ?><header class="header-content"><div class="<?php echo $fluid_header; ?>"><div class="row"><div class="column col-xs-12"><?php print render($page['header']);?></div></div></div></header><?php endif; ?>
...
<?php if (!empty($page['footer'])): ?><footer class="<?php echo $fluid_footer; ?> "><?php print render($page['footer']); ?></footer><?php endif; ?>
